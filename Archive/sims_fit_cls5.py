...
def peak_cycles(obj, focus_df, min_range=2, start=None, stop=None, full_stop=None, pair_set='all'):
...
class Analysis:
    ...
    def peaks(self, peak=0, start=None, stop=None, full_stop=None, min_range=3, pair_set=None,

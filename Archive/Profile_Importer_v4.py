    ...
    def rice_raw(self, raw, **kwargs):
        ...
        for key, val in res_dict.items():
            if "conc" in key:
                ...
                val = val.set_index(
                    ut.Length(val.index.to_numpy(), "um").cm
                ).reset_index()
                res_alt = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if path is not None:
            ...
            self.outpath = ut.root_path("work\\Data\\Analysis\\SIMS\\RICE\\220425 Man\\Results")
...
class BulkImport:
    def __init__(self, call, calc=False, folder="Bulk_import", **kwargs):
        ...
        prime_path = ut.root_path("work\\Data\\Analysis\\SIMS") + "\\"
        active_log = (
